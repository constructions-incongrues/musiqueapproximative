            ...
            <section class="contributors">
                <div class="grid-90 prefix-5 suffix-5">
                     ...
                     <div class="grid-50 push-50 about">
                        ...
                        <p>
                            <br />Le <a href="https://gliche.constructions-incongrues.net?glitch?url=<?php echo urlencode($sf_request->getUriPrefix().$sf_request->getRelativeUrlRoot().'/images/logo.png') ?>&amount=75&seed=<?php echo $post->getId(); ?>">logo</a> a été créé par <a href="http://iris.ledrome.com/">Iris Veverka</a>.
                        </p>
                        <h2>
                            Aidez-nous !
                        </h2>
