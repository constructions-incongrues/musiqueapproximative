...
(function (Popcorn) {
  var JQUERY_SCRIPT =
      "http://ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js", // Used if jQuery not already present.
    ...
    format = {
      // Duplicate of jPlayer 2.2.0 object, to avoid always requiring jQuery and jPlayer to be loaded before performing the _canPlayType() test.
      mp3: {
