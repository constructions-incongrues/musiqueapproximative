...
(function (e, t) {
  ...
  function bn(e, t, n) {
    var r,
      ...
      l = f.props;
    wn(l, f.opts.specialEasing);
    for (; i < o; i++) {
      r = vn[i].call(f, e, l, f.opts);
      if (r) return r;
    }
    return (
      yn(f, l),
  ...
  ((v.fn = v.prototype =
    {
      ...
      selector: "",
      jquery: "1.8.2 -deprecated,-ajax,-ajax/jsonp,-ajax/script,-ajax/xhr",
      length: 0,
      size: function () {
        return this.length;
      },
  ...
  ((v.Animation = v.extend(bn, {
    tweener: function (e, t) {
      v.isFunction(e) ? ((t = e), (e = ["*"])) : (e = e.split(" "));
      var n,
        r = 0,
        i = e.length;
      for (; r < i; r++) ((n = e[r]), (mn[n] = mn[n] || []), mn[n].unshift(t));
    },
    ...
    (Sn.prototype = {
      ...
      run: function (e) {
        ...
        return (
          ...
          n && n.set ? n.set(this) : Sn.propHooks._default.set(this),
          this
        );
      },
    }),
      ...
      stop: function (e, n, r) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (n in o) o[n] && o[n].stop && dn.test(n) && i(o[n]);
            for (n = s.length; n--; )
              s[n].elem === this &&
                (e == null || s[n].queue === e) &&
    ...
    (v.fx.timer = function (e) {
      e() &&
        v.timers.push(e) &&
        !cn &&
        (cn = setInterval(v.fx.tick, v.fx.interval));
    }),
    (v.fx.interval = 13),
    (v.fx.stop = function () {
  ...
  jPlayerPlaylist.prototype = {
    ...
    add: function (a, c) {
      ...
      c
        ...
        : this.original.length === 1 && this.select(0);
    },
    remove: function (a) {
      var c = this;
      if (a === f)
