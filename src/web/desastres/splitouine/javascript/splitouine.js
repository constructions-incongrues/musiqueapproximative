...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    window.DesastreAudio.onReady(function(audio) {
        ...
        if (!window.DesastreOptions.splitouine.tween.configuration.duration) {
            window.DesastreOptions.splitouine.tween.configuration.duration = audio.duration;
            console.log("[desastres/splitouine] Auto-matched duration to audio:", audio.duration + "s");
        }
        ...
        console.log("[desastres/splitouine] Animation started on:", window.DesastreOptions.splitouine.tween.type);
    });
});