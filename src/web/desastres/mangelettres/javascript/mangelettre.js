document.addEventListener("DOMContentLoaded", (event) => {
    window.DesastreAudio.onReady(function(audio) {
        ...
        let split = SplitText.create(window.DesastreOptions.mangelettres.selector || 'section.content', {
            "type": "chars",
            "mask": "chars",
            "autoSplit": true,
            "charsClass": "char++"
        ...
        console.log('[desastres/mangelettres] Analyzing', split.chars.length, 'characters');
        ...
        const duration = window.DesastreOptions.mangelettres.duration || audio.duration.toFixed(0);
        const stagger = window.DesastreOptions.mangelettres.stagger || 0.02
        const speed = window.DesastreOptions.mangelettres.speed || 1

        console.log('[desastres/mangelettres] Will remove', charsToRemove.length, 'characters in', audio.duration, 'seconds');
