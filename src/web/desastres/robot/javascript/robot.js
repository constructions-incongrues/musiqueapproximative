...
window.onload = function () {
  ...
  for (let i = 0; i < letters.length; i += 2) {
    ...
    letters[i].animate(
      [
        {
          transform:
            "translateX(-10px) perspective(40cm) rotateX(0deg) rotateY(-60deg)",
          opacity: 1,
        },
        {
          transform:
            "translateX(20px) perspective(40cm) rotateX(0deg) rotateY(60deg)",
          opacity: 1,
        },
        {
          transform:
            "translateX(30px) perspective(40cm) rotateX(0deg) rotateY(60deg)",
          opacity: 0,
        },
        {
          transform:
  ...
  for (let i = 1; i < letters.length; i += 2) {
    ...
    letters[i].style.transform =
      "translateY(-50px) perspective(40cm) rotateX(-60deg) rotateY(0deg)";
    setTimeout(() => {
      letters[i].animate(
        [
          {
          ...
          {
            transform:
              "translateY(30px) perspective(40cm) rotateX(60deg) rotateY(0deg)",
            opacity: 1,
          },
          {
            transform:
          ...
          {
            transform:
              "translateY(-10px) perspective(40cm) rotateX(-60deg) rotateY(0deg)",
          },
          {
