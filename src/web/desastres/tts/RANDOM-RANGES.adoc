...
. *Valeur fixe* (nombre) : La valeur est utilisée telle quelle
. *Plage aléatoire* (tableau) : Une valeur aléatoire est tirée entre min et max
...
----
# Voir README-TRIGGER.adoc dans le plugin sfDesastrePlugin
...
* xref:./README.adoc[README.adoc] - Documentation complète du désastre TTS
* xref:./N8N-WORKFLOW-NO-CODE.adoc[N8N-WORKFLOW-NO-CODE.adoc] - Workflow n8n pour jingles contextuels
* xref:../../plugins/sfDesastrePlugin/README-TRIGGER.adoc[README-TRIGGER.adoc] - Système de triggers par URL
