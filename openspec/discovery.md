...
> Status: complete
> Created: 2026-08-18 · Last revised: 2026-08-19 (trente-cinquième révision)
...
- [x] 33. `desastre-la-bande-usee` — le premier désastre qu'on ne peut pas voir
  - **Change** : `desastre-la-bande-usee` (archivé) — nom identique. Archivé le 2026-08-19
    sur décision du mainteneur, la tâche 6.1 restant ouverte : l'écoute portera sur le
    résultat final, âge compris, plutôt que sur un réglage intermédiaire.
...
- [x] 35. `lier-l-usure-a-l-age-du-morceau` — l'archive s'entend
  - **Change** : `lier-l-usure-a-l-age-du-morceau` (archivé) — nom identique
...
- 2026-08-19 (trente-cinquième révision) — **La story 35 est livrée : l'archive s'entend.**
  Le catalogue couvre 6 643 jours et l'ancienneté n'avait jamais rien déclenché ni modulé ;
  elle module désormais l'usure — 4,4 cents pour un morceau d'aujourd'hui, 28,6 pour un de
  2008.
  **La courbe a été choisie sur les morceaux réels**, comme le packet l'exigeait. La linéaire
  placerait 43 % du catalogue dans la bande la plus altérée : l'usure serait l'état normal
  plutôt que la marque d'un âge. L'exposant 2 la réserve au tiers réellement ancien, et un
  plancher évite que 29 % des morceaux reçoivent un désastre inaudible alors que l'en-tête
  l'annonce.
  **La référence est une constante et non l'étendue du catalogue** — celle-ci grandit chaque
  jour, et l'usure d'un morceau dériverait sans décision.
  **Une vérification a trouvé un défaut que rien d'autre n'aurait vu** : le processeur
  postait le modulateur brut. Le titre aurait dérivé autant sur un morceau d'hier que sur un
  de 2008, l'œil contredisant l'oreille au lieu de la confirmer — l'inverse de ce pour quoi
  les contrepoints existent.
  **Au passage, la page d'un morceau porte enfin sa date de publication.** Elle n'y figurait
  nulle part, ce qui est notable pour une archive de dix-huit ans.
