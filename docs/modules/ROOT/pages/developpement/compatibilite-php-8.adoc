...
L'intégration continue exécute donc la suite sous *les deux* versions, 7.4 et 8.1, avec
le même statut bloquant. `fail-fast` est désactivé pour que les deux rendent leur verdict.
