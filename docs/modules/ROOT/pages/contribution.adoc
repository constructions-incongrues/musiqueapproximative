...
:description: Comment contribuer au projet Musique Approximative
...
Suivez les instructions dans le xref:guide-demarrage.adoc[guide de démarrage] pour configurer Docker et démarrer l'application.
