...
:description: Utilisation de Docker et GHCR pour le déploiement
...
1. Aller sur https://github.com/constructions-incongrues/musiqueapproximative/pkgs/container/musiqueapproximative
