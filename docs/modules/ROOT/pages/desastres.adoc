...
. **Documenter** : Créer `src/web/desastres/mon-desastre/README.md`
...
* **Documentation** : Chaque désastre doit avoir un README.md
...
**Les désastres sont le cœur créatif de Musique Approximative** 🎭 +
Amusez-vous à créer des expériences uniques et surprenantes !
